...
class register extends Component {
    ...
    render() {
        ...
        //above can also be written like in below
        //const {errors} = this.state; // {} is the deconstruction symbol
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <form onSubmit={this.onSubmit.bind(this)}>
                            ...
                            <input type="text" className={classnames("form-control form-control-lg", {'is-invalid': errors.name})} placeholder="Name" name="name" value={this.state.name} onChange={this.onChange.bind(this)}/>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                            <input type="password" className= {classnames("form-control form-control-lg", {'is-invalid': errors.password2})} placeholder="Confirm Password" name="password2" value={this.state.password2} onChange={this.onChange.bind(this)}/>
                            </div>
